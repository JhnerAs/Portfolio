...
/* ═══════════════════════════════════════════════════
   INTRO — particle canvas + "Jhner.Dev" typewriter
═══════════════════════════════════════════════════ */
(function(){
...
/* ═══════════════════════════════════════════════════
   ...
   Bug fixes:
   1. touchBlock was boolean — cant set ._t on it → use separate touchTimer var
   2. CSS had default transform:translate(-50%,-50%) conflicting with JS → removed
   3. pointer:coarse alone blocks BT mouse → now uses pointer:coarse AND hover:none
═══════════════════════════════════════════════════ */
(function(){
